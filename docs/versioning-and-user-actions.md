...
| Scope | Canonical version | Status |
|---|---|---|
| Approved `main` | `core-1.2.0` | Three-mode router approved |
| Active `dev` | `dev-1.3.0` | Next development train |
| Next target | `core-1.3.0` | Not approved yet |
...
## Conversation routing — core-1.2.0

The approved system has three user-facing conversation modes:
