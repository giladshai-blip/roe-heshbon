...
- approved `main`: `core-1.3.0`
- active `dev`: `dev-1.4.0`
- next promotion target: `core-1.4.0`
- latest approved main SHA: `ce1b29318f850ab619b41c3db61f8407322d900a`

`dev-1.4.0` introduces the DEV engineering agent contract and formalizes technical/versioning ownership under Gabi, together with the corrected Dashboard release identity.
...
Example: Apps Script may still carry Legacy Build ID `V5.10.1`, while the active repository release is `dev-1.4.0`.
...
Current restore base: `core-1.3.0`.
